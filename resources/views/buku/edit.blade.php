                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('buku.update', $buku->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="harga_pokok" name="harga_pokok" value="{{ $buku->harga_pokok }}">
                            </div>
                            <div class="form-group">
                                <label for="harga_jual">Harga Jual</label>
                                <input type="text" class="form-control" id="harga_jual" name="harga_jual" value="{{ $buku->harga_jual }}">
                            </div>
